...
project_type.set_field('timeEntries', time_entry_queries.resolve_time_entries_for_project)

timeEntry_type = ObjectType('TimeEntry')
timeEntry_type.set_field('user', user_queries.resolve_user_for_time_entry)
timeEntry_type.set_field('project', project_queries.resolve_project_for_time_entry)
