...
const navigation = [
    { name: 'Dashboard', href: createRoute('/dashboard'), icon: HomeIcon, current: route.path == '/dashboard' },
    { name: 'Users', href: createRoute('/dashboard/users'), icon: UsersIcon, current: route.path == '/dashboard/users' },
    { name: 'Projects', href: createRoute('/dashboard/projects'), icon: FolderIcon, current: route.path == '/dashboard/projects' },
    { name: 'Calendar', href: '#', icon: CalendarIcon, current: false },
    { name: 'Documents', href: '#', icon: DocumentDuplicateIcon, current: false },
    { name: 'Reports', href: '#', icon: ChartPieIcon, current: false },
]

console.log("logout", createRoute('/logout'));

const userNavigation = [
    { name: 'Your profile', href: '#' },
    { name: 'Sign out', href: createRoute('/logout') },
]
